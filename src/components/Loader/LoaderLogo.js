    ...
    return (
      ...
      >
        ...
        <path
          ...
          strokeWidth="3"
        />
        {/* Letter N (replaces previous H) */}
        <path
          className="letter"
          d="M220 158V110.456H232.5L248 143.5V110.456H256V158H243.5L228 124.956V158H220Z"
          stroke={theme.body}
          strokeWidth="3"
        />
        {/* Example for showing "Amay Nagpal" below the logo. Uncomment if needed. */}
        <text
  x="57.5%"
  y="90%"
  textAnchor="middle"
